...
class _4_6staticTest {
	// 객체를 정의 생성하는 툴인 _4_6staticTest라는 클래스를 만든다

	public static void main(String[] args) {

		_4_6static b1 = new _4_6static();
		// _4_6staticTest클래스의 객체를 담는 b1변수에 _4_6staticTest 클래스의 객체를 새로 생성하여 저장한다
		_4_6static b2 = new _4_6static();
		// _4_6staticTest클래스의 객체를 담는 b2변수에 _4_6staticTest 클래스의 객체를 새로 생성하여 저장한다
		b1.name = "Java";
